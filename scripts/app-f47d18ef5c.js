 ...
 *
 */
function(){"use strict";var e=function(e,t,i){var a={},n={},r=!0,o=function(o,s){if(a[o])return a[o];if(!n[o]){var c="http://"+i.properties.host+":31300/getid/";if(r&&(c="http://wedge-fb-1:3000/service?id="),e.get(c+o).then(function(e){if(r){var t=e.data.result;""!==t&&(a[o]=t)}else a[o]=e.data})["catch"](function(){t.debug("Unexpected response from resolver"),n[o]=!0}),-1!==s.values[s.values.length-1].y.indexOf("mesos"))return o}};return{resolve:o}};e.$inject=["$http","$log","$rootScope"],angular.module("vector").factory("containerNameResolver",e)}(),/**!
 *
 *  Copyright 2015 Netflix, Inc.
 *
 *     Licensed under the Apache License, Version 2.0 (the "License");
...
//# sourceMappingURL=../maps/scripts/app-f47d18ef5c.js.map
